                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('kamars.update', $kamar->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nomor_kamar" id="nomor_kamar" class="form-input w-full @error('nomor_kamar') border-red-500 @enderror" value="{{ old('nomor_kamar', $kamar->nomor_kamar) }}" required>
                            @error('nomor_kamar')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="jenis_kamar" id="jenis_kamar" class="form-input w-full @error('jenis_kamar') border-red-500 @enderror" value="{{ old('jenis_kamar', $kamar->jenis_kamar) }}" required>
                            @error('jenis_kamar')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
